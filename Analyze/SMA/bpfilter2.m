function Hd = bpfilter2(Fpass1, Fpass2, Fs)
%BPFILTER2 Returns a discrete-time filter object.

%
% M-File generated by MATLAB(R) 7.10 and the Signal Processing Toolbox 6.13.
%
% Generated on: 27-Jul-2011 03:10:27
%
...
N      = 1000;  % Order
Fstop1 = Fpass1-5;    % First Stopband Frequency
%Fpass1 = 58;    % First Passband Frequency
%Fpass2 = 60;    % Second Passband Frequency
Fstop2 = Fpass2+5;    % Second Stopband Frequency
