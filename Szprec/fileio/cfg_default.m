...
cfg.use_log=true;                  % If true apply log transform to min F values, otherwise use asin transform
...
% Main Values for Amplitude stats
...
%% Main changes for Current FBand analysis
